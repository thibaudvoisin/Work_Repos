...
namespace Notepad.Objects
{
    public class Session
    {
        ...
        private static string _applicationPath = Path.Combine(_applicationDataPath, "3WM Studio");

        private readonly XmlWriterSettings _writterSettings;

        public static string BackupPath = Path.Combine(_applicationDataPath, "3WM Studio", "backup");
